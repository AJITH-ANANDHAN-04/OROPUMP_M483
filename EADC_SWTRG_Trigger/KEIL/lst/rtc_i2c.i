#line 1 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 2 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 3 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 4 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 5 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 10 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 11 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
#line 12 "..\\..\\..\\..\\Library\\StdDriver\\src\\Rtc_I2c.c"
...
volatile uint8_t No_of_Bytes = 0;
unsigned char Read_DATA[10];
uint8_t Read_Address =0,Write_Address=0,Write_DATA=0,Read_Count;
...
void I2C_MasterRx(uint32_t u32Status)
{
    if (u32Status == 0x08)                       
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT = ((g_u8DeviceAddr << 1)));  
    ...
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT = (Read_Address));
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x08UL));
    }
    else if (u32Status == 0x20)                  
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x20UL | 0x10UL | 0x08UL));
    }
    else if (u32Status == 0x28)                  
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x20UL | 0x08UL));
    }
    else if (u32Status == 0x10)                  
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT = ((g_u8DeviceAddr << 1) | 0x01));   
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x08UL));
    }
    ...
    {
			g_u8RxData = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT);
			if(Read_Count != 1)
				{
					Read_DATA[Read_Count-1] = (unsigned char) ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT);
				}
		...
		{
				Read_DATA[Read_Count] = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT);
				Read_Count++;
			if(Read_Count == 1)
		 {
			((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x08UL));
		 ...
		 else if(No_of_Bytes<(Read_Count-1))
		 {
...
void I2C_MasterTx(uint32_t u32Status)
{
    ...
    {
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT = (Write_Address));
        ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x08UL));
    }
    else if (u32Status == 0x20)                  
    {
    ...
    else if (u32Status == 0x28)                  
    {
       if(No_of_Bytes==0)
			{
            ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->DAT = (Write_DATA));
				    No_of_Bytes++;
            ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))->CTL0 & ~0x3c) | (0x08UL));
      }
        else
...
void Hex2BcdConversion(unsigned char *Value)
{
	unsigned char rtc_val1=0,rtc_val2=0;
	rtc_val1=(*Value&0x0f);			
	rtc_val2=(*Value>>4);
	*Value = (rtc_val2*10)+rtc_val1; 
}
void Bcd2HexConversion(unsigned char *Value)
{
	unsigned char ll,hl,tl;
	hl = *Value/10;
	ll = *Value%10;
	tl = hl<<4;
	tl = tl|ll;
...
void Rtc_Init(void)
{
	...
	rtc_val=0xD8;
  I2C0_Write_RTC(0x32,0x17,rtc_val);
	Delay_Msec(5);
	rtc_val=0x00;
	I2C0_Write_RTC(0x32,0x30,rtc_val);
	Delay_Msec(5);
	rtc_val=0x08;
	I2C0_Write_RTC(0x32,0x31,rtc_val);
	Delay_Msec(5);
	rtc_val=0x01;
	I2C0_Write_RTC(0x32,0x32,rtc_val);
	Delay_Msec(5);
	
	rtc_val=0x00;
  I2C0_Write_RTC(0x32,0x1D,rtc_val);
	Delay_Msec(5);
	
    rtc_val =I2cReadByte(0x32,0X1E); 
	Delay_Msec(5);
	rtc_val=rtc_val&0xFD;
  I2C0_Write_RTC(0x32,0x1D,rtc_val);
	Delay_Msec(5);
	
    rtc_val = I2cReadByte(0x32,0X1F);
	Delay_Msec(5);
	rtc_val=rtc_val&0x00;
  I2C0_Write_RTC(0x32,0x1F,rtc_val);
	Delay_Msec(5);
...
void RTC_PowerON(void)
{
	...
	rtc_val = I2cReadByte(0x32,0X1E);  
	if((rtc_val&0x02) == 0x02)     
	{
		rtc_val= rtc_val&0xFD;
    I2C0_Write_RTC(0x32,0x1E,rtc_val);
		Delay_Msec(10);
		rtc_val=0;
		rtc_val = I2cReadByte(0x32,0X1E);
		Delay_Msec(10);
		while(1)
		{
			if((rtc_val&0x02) == 0x00)
			{
				break;
			}
			printf("rtc in the loop:%d",rtc_val);
			printf("rtc_val hexa %x",rtc_val);
...
void ReadDateTime(void)
{	
	datetime.tm_sec=I2cReadByte(0x32,0x10);
	Hex2BcdConversion((uint8_t *)&datetime.tm_sec);
  datetime.tm_min=I2cReadByte(0x32,0x11);
	Hex2BcdConversion((uint8_t *)&datetime.tm_min);
	datetime.tm_hour=I2cReadByte(0x32,0x12);
	Hex2BcdConversion((uint8_t *)&datetime.tm_hour);
	datetime.tm_mday=I2cReadByte(0x32,0x14);
	Hex2BcdConversion((uint8_t *)&datetime.tm_mday);
	datetime.tm_mon=I2cReadByte(0x32,0x15);
	Hex2BcdConversion((uint8_t *)&datetime.tm_mon);
	datetime.tm_year=I2cReadByte(0x32,0x16);
	Hex2BcdConversion((uint8_t *)&datetime.tm_year);
	
	if(debugon==1) {
		printf("TIME:%02d:%02d:%02d\t",datetime.tm_hour,datetime.tm_min,datetime.tm_sec);
		printf("DATE: %02d/%02d/%04d\n",datetime.tm_mday,datetime.tm_mon,datetime.tm_year+2000);
	}
 }

int8_t SetDateTime(struct _rtc datetime)
{
	Bcd2HexConversion((uint8_t *)&datetime.tm_sec);
	I2C0_Write_RTC(0x32,0x10,datetime.tm_sec);
	Bcd2HexConversion((uint8_t *)&datetime.tm_min);
	I2C0_Write_RTC(0x32,0x11,datetime.tm_min);
	Bcd2HexConversion((uint8_t *)&datetime.tm_hour);
	I2C0_Write_RTC(0x32,0x12,datetime.tm_hour);
	Bcd2HexConversion((uint8_t *)&datetime.tm_mday);
	I2C0_Write_RTC(0x32,0x14,datetime.tm_mday);
	Bcd2HexConversion((uint8_t *)&datetime.tm_mon);
	I2C0_Write_RTC(0x32,0x15,datetime.tm_mon);
	Bcd2HexConversion((uint8_t *)&datetime.tm_year);
	I2C0_Write_RTC(0x32,0x16,datetime.tm_year);
	
	ReadDateTime();
	if((datetime.tm_hour <= 0 && datetime.tm_min <= 0 && datetime.tm_sec <=0 )|| (datetime.tm_mday <= 0 || datetime.tm_mon <= 0 || datetime.tm_year <=0))
		return -1;
	else 
		return 0;
